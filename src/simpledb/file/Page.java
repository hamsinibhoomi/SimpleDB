...
public class Page {
   ...
   /**
    * 
    * retrieves a short data type from the specified offset of the page
    * @param offset
    * @return
    */
   ...
   /**
    * writes a short data type at the specified offset of the page
    * @param offset
    * @param val
    */
   ...
   /**
    * retrieves a boolean data type from the specified offset of the page
    * @param offset
    * @return
    */
   public synchronized boolean getBoolean(int offset){
		...
		byte[] byteval = new byte[len];
		contents.get(byteval);
		return new Boolean(new String(byteval));
   }
   
   /**
    * sets a boolean data type at the specified offset of the page
    * @param offset
    * @param val
    */
   public synchronized void setBoolean(int offset, boolean val){
	   contents.position(offset);
	   String bool = Boolean.toString(val);
	   byte[] byteval = bool.getBytes();
	   contents.putInt(byteval.length);
	   contents.put(byteval);
   }
   
   /**
    * gets an array of bytes from a specified offset of the page
    * @param offset
    * @return
    */
   ...
   /**
    * sets an array of bytes at the specified offset of the page
    * @param offset
    * @param val
    */
   ...
   /**
    * gets date object from a specified offset of a page
    * @param offset
    * @return
    */
   public synchronized Date getDate(int offset){
		...
		byte[] byteval = new byte[len];
		contents.get(byteval);
		return new Date(new String(byteval));
   }
   
   /**
    * sets the date object at a specified offset of a page
    * @param offset
    * @param val
    */
